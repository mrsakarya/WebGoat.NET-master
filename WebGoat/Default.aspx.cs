...
namespace OWASP.WebGoat.NET
{
	public partial class Default : System.Web.UI.Page
	{
        ...
        {
            Denemeler d = new Denemeler();
            var k = Request.QueryString["email"];
            d.ParolaGir(k);
            ...
            if (du.TestConnection())
            {
                ...
                //Info leak
                HttpCookie cookie = new HttpCookie("Server", Encoder.Encode(Server.MachineName)); HttpCookie cookie1 = new HttpCookie("Server", Encoder.Encode(Server.MachineName)); HttpCookie cookie2 = new HttpCookie("Server", Encoder.Encode(Server.MachineName)); HttpCookie cookie3 = new HttpCookie("Server", Encoder.Encode(Server.MachineName)); HttpCookie cookie4 = new HttpCookie("Server", Encoder.Encode(Server.MachineName));
